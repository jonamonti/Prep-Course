...
function colors(color) {
  ...
  var1 = 'This is '
  if (color === 'blue') return var1 + color
  else if (color === 'red') return var1 + color
  else if (color === 'green') return var1 + color
  else if (color === 'orange') return var1 + color
...
function fizzBuzz(numero) {
  ...
  var3 = numero % 3
  var5 = numero % 5
  if (var3 === 0 && var5 === 0) return 'fizzbuzz'
  else if (var3 === 0) return 'fizz'
  else if (var5 % 5 === 0) return 'buzz'
  return numero
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (Math.abs(numero) >= 100 && Math.abs(numero) < 1000 ) return true
  return false
